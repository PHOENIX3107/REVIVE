...
from backend.schemas import Downtime, Order, PaymentAttempt, SignalContext
...
class RecoveryCaseProcessor:
    ...
    def process(self, case_id: str) -> RecoveryCaseProcessingResult:
        ...
        if existing is not None:
            return self._existing_result(case_id, order, payment, existing)
        ...
        decision = evaluate_policy(order, payment, signal, downtime, diagnosis)
